  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white selection:bg-blue-500 selection:text-white">
      ...
      <main className="flex-1 p-6 md:p-10 overflow-y-auto">
        ...
        {/* 
        <div className="mt-10 bg-slate-800/70 p-6 rounded-xl shadow-lg border border-slate-700">
           <h3 className="text-xl font-semibold text-sky-400 mb-4">Activity Overview</h3>
           <p className="text-slate-400">Charts and activity logs will appear here...</p>
        </div>
        */}
      </main>
    </div>
